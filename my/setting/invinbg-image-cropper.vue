<template>
    <view class="vue-cropper" ref="cropper" :style="{ top : `${containerTop}px` }" v-show="show">
        ...
        <view class="cropper-crop-box" :class="{'pointer-events': cropFixed}" :style="{'width': cropW + 'px','height': cropH + 'px','transform': 'translate3d('+ cropOffsertX + 'px,' + cropOffsertY + 'px,' + '0)'}">
            ...
            <view v-if="!cropFixed" class="cropper-face cropper-move" ></view>
            ...
            <block v-if="!cropFixed">
                <view class="crop-point point-lt"></view>
                <view class="crop-point point-mt"></view>
                <view class="crop-point point-rt"></view>
                <view class="crop-point point-ml"></view>
                <view class="crop-point point-mr"></view>
                <view class="crop-point point-lb"></view>
                <view class="crop-point point-mb"></view>
                <view class="crop-point point-rb"></view>
            </block>
        </view>
